...
$sql = "INSERT INTO rentals (user_id, bike_id, pickup_station, start_date, end_date, duration_days, total_amount, mpesa_phone, payment_status, rental_status, rental_type)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'paid', ?, ?)";
